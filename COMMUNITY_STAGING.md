...
## 使用者更正：交流區主體是公開留言板
2026-09-22新增自由留言板作為/community.html主入口。未登入可瀏覽；登入並確認暱稱後可發文、回覆，不需日期或五碼，不限每天一篇。分類自由聊聊/號碼心得/我想請教，標題選填80字、本文2000字，發言間隔30秒。獨立board_messages資料表不計入選號共識；requestKey避免重試重複發文。主題及回覆均支援檢舉/管理員隱藏；隱藏主題不可再讀取或回覆。每頁30筆，有更早分享及更早回覆分頁。
原選號功能保留/numbers.html，首頁導向留言板。保留全部既有LINE、Production與官方來源限制。
